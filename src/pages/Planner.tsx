...
const days = [
  { name: 'Пн, 23 мая', label: 'Маркетинговая кампания VK', tone: 'ok' },
  { name: 'Вт, 24 мая', label: 'Обучение менеджеров', tone: 'warn' },
  { name: 'Ср, 25 мая', label: 'Проверка склада', tone: 'info' },
  { name: 'Чт, 26 мая', label: '', tone: '' },
  { name: 'Пт, 27', label: 'Отгрузки', tone: 'warn', active: true },
  { name: 'Сб, 28 мая', label: 'Монтажи', tone: 'crit' },
  { name: 'Вс, 29 мая', label: '', tone: '' },
];
const hours = ['08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00'];

type Ev = { day: number; start: number; span: number; title: string; sub: string; color: string };
const events: Ev[] = [
  { day: 0, start: 1, span: 1, title: '09:00 – 10:00 Замер', sub: 'Мария Петрова, ЖК «Сити Парк», Кв. 45', color: 'hsl(150 40% 30%)' },
...
const myTasks = [
  { time: '09:00', title: 'Замер у клиента', sub: 'Мария Петрова, ЖК «Сити Парк», кв. 45', prio: 'Низкий', tone: 'ok' },
...
const events5 = [
  { date: '24 мая, 08:30', title: 'Контрольный замер', sub: 'Ольга Кузнецова', tone: 'crit' },
  { date: '25 мая, 09:00', title: 'Замер у клиента', sub: 'Наталья Соколова', tone: 'ok' },
  { date: '26 мая, 12:00', title: 'Согласование чертежей', sub: 'Технология', tone: 'warn' },
  { date: '27 мая, 09:00', title: 'Отгрузка заказа №1258', sub: 'Кухня и остров', tone: 'crit' },
  { date: '28 мая, 10:00', title: 'Монтаж детской мебели', sub: 'Бригада №2', tone: 'info' },
];

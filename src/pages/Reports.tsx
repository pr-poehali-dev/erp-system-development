...
const lastOrders = [
  { n: '№1258', client: 'Мария Петрова', obj: 'Квартира, ЖК «Парковый», Симферополь', sum: '1 245 000 ₽', status: 'В производстве', tone: 'ok', mgr: 'Иванова А.С.', date: '21.06.2026' },
  { n: '№1256', client: 'Алексей Смирнов', obj: 'Квартира, ЖК «Центральный», Симферополь', sum: '980 000 ₽', status: 'Готов к монтажу', tone: 'info', mgr: 'Петрова Е.В.', date: '23.06.2026' },
  { n: '№1261', client: 'Ольга Кузнецова', obj: 'Дом, Симферопольский р-н', sum: '750 000 ₽', status: 'Согласование', tone: 'warn', mgr: 'Кузнецов Д.А.', date: '27.06.2026' },
  { n: '№1263', client: 'Игорь Волков', obj: 'Офис, БЦ «Крымский», Симферополь', sum: '1 130 000 ₽', status: 'Проектирование', tone: 'purple', mgr: 'Иванова А.С.', date: '30.06.2026' },
];

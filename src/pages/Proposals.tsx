...
const proposals = [
  { id: 'КП-1258', ver: 'версия 2', client: 'Мария Петрова', deal: 'Сделка №1258', item: 'Кухня и остров', company: 'ТМ', sum: '1 850 000 ₽', status: 'Согласуется', tone: 'warn', date: '23.05.2024 14:20', mgr: 'Иванова А.С.' },
  { id: 'КП-1246', ver: 'версия 1', client: 'Алексей Смирнов', deal: 'Сделка №1261', item: 'Гостиная и ТВ-зона', company: 'ТМ', sum: '950 000 ₽', status: 'Отправлено', tone: 'info', date: '22.05.2024 16:30', mgr: 'Иванова А.С.' },
  { id: 'КП-1241', ver: 'версия 1', client: 'Наталья Соколова', deal: 'Сделка №1262', item: 'Кухня классика', company: 'ТМ', sum: '1 280 000 ₽', status: 'Черновик', tone: 'muted', date: '22.05.2024 11:20', mgr: 'Смирнов Д.А.' },
  { id: 'КП-1235', ver: 'версия 3', client: 'Игорь Волков', deal: 'Сделка №1263', item: 'Прихожая', company: 'ТМ', sum: '380 000 ₽', status: 'Принято', tone: 'ok', date: '21.05.2024 17:00', mgr: 'Иванова А.С.' },
  { id: 'КП-1232', ver: 'версия 1', client: 'Ольга Кузнецова', deal: 'Сделка №1262', item: 'Комплексный проект', company: 'ТМ', sum: '2 460 000 ₽', status: 'Отклонено', tone: 'crit', date: '21.05.2024 12:10', mgr: 'Кузнецов Д.А.' },
  { id: 'КП-1228', ver: 'версия 2', client: 'Максим Фролов', deal: 'Сделка №1267', item: 'Кухня и остров', company: 'К+', sum: '675 000 ₽', status: 'Требует правки', tone: 'warn', date: '20.05.2024 15:40', mgr: 'Петрова Е.В.' },
  { id: 'КП-1225', ver: 'версия 1', client: 'Екатерина Лебедева', deal: 'Сделка №1264', item: 'Шкафы и гардеробная', company: 'К+', sum: '420 000 ₽', status: 'Отправлено', tone: 'info', date: '20.05.2024 10:30', mgr: 'Петрова Е.В.' },
  { id: 'КП-1220', ver: 'версия 1', client: 'Виктория Морозова', deal: 'Сделка №1268', item: 'Детская мебель', company: 'К+', sum: '310 000 ₽', status: 'Согласуется', tone: 'warn', date: '19.05.2024 16:45', mgr: 'Смирнов Д.А.' },
  { id: 'КП-1215', ver: 'версия 1', client: 'Антон Гусев', deal: 'Сделка №1269', item: 'Кухня угловая', company: 'К+', sum: '520 000 ₽', status: 'Принято', tone: 'ok', date: '19.05.2024 14:10', mgr: 'Кузнецов Д.А.' },
  { id: 'КП-1210', ver: 'версия 1', client: 'Юлия Белова', deal: 'Сделка №1270', item: 'Гардеробная', company: 'К+', sum: '260 000 ₽', status: 'Черновик', tone: 'muted', date: '18.05.2024 11:50', mgr: 'Петрова Е.В.' },
];
          ...
          <div className="glass-card rounded-2xl p-5 animate-fade-in opacity-0" style={{ animationDelay: '80ms' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="space-y-3 text-sm">
                ...
                {[['Клиент', sel.client], ['Сделка', sel.deal.replace('Сделка ', '')], ['Компания', sel.company === 'ТМ' ? 'Территория Мебели' : 'Контур+'], ['Направление', sel.item], ['Адрес объекта', 'Москва, ЖК «Сити Парк», ул. Мантулинская, 9, кв. 45'], ['Менеджер', sel.mgr], ['Срок действия КП', 'до 06.06.2024']].map(([l, v]) => (
